...
class VerificationController(EventHook):
    ...
    === "on_each_plugin_start"
        ...
        ```
        References:
            1. [VerificationConfig][vzmi.ychaos.testplan.verification.VerificationConfig]
    ...
    === "on_each_plugin_end"
        ...
        References:
            1. [VerificationConfig][vzmi.ychaos.testplan.verification.VerificationConfig]
            2. [VerificationStateData][vzmi.ychaos.core.verification.data.VerificationStateData]
