...
class DocStub(object):
    __version__ = '0.0.0'
    __name__ = 'Unknown'
    __copyright__ = 'Copyright 2020 Verizon Media Inc.'
    
try:
    import vzmi.ychaos as doc_module
except ImportError:
    doc_module = DocStub()
...
try:
    ...
    github_doc_root = 'https://git.vzbuilders.com/pages/ssharma06/vzmi.ychaos'
    USE_MARKDOWN = True
except ImportError:
    USE_MARKDOWN = False
...
extlinks = {
    'issue': ('https://git.vzbuilders.com/ssharma06/vzmi.ychaos/issues/%s', 'issue '),
    'jira': ('https://jira.vzbuilders.com/browse/%s', 'jira:'),
